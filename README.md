...
## Version History
# 🛠️ AstroAuction Patch 1.1.0
📅 **Release Date:** September 15th, 2026

## 📢 Developer's Notes - Guide to post a listing

- here's a tutorial with version 1.1 
  - ![tutorial](/gitimages/tutorialdemo.gif)

---------------------------------------------------------------------------------------------------------------------------
# 🛠️ AstroAuction Patch 0.9.037
📅 **Release Date:** September 11th, 2026

## 📢 Developer's Notes - 

- Add/Updated tests - 180/180 passing
...
## 📢 Developer's Notes - Announcement system?

- The idea is that when a listing gets posted, the business owner can broadcast/livestream, then click a button to "spotlight" auctions that are happening in real time
  - ![o](/gitimages/spotlight.gif)

- [X] An announcement feature
- [X] An auction feature
- [X] A listings feature - refactored
---------------------------------------------------------------------------------------------------------------------------
# 🛠️ AstroAuction Patch 0.9.034
📅 **Release Date:** September 7th, 2026

## 📢 Developer's Notes - Unit tests

- Increased multer's fileSize property-value - files 10MB and lower can be uploaded
- Added 9 tests suites with 145 tests - all 145/145 passing
- Uploading a file above 10MB will give you a flash message with the error messsage vs sending you to a 500 error landing page
...
## 📢 Developer's Notes - Refactor/bug fix

- Logging in & out is enabled, most things appear to be working
  - Our flash messages will now render after logging in (previously did not render)
  - I had redirections going all over, and the default is now the home route `'/'`
  - Updated pathing to error pages within the `catch` blocks

---------------------------------------------------------------------------------------------------------------------------
# 🛠️ AstroAuction Patch 0.9.029
📅 **Release Date:** August 7th, 2026

## 📢 Developer's Notes - Front-end eye candy

- Added hover effects & decorative corners to the hero image
- Added several animated particle effects using the `canvas` API

---------------------------------------------------------------------------------------------------------------------------
# 🛠️ AstroAuction Patch 0.9.028
📅 **Release Date:** August 6th, 2026

## 📢 Developer's Notes - Update dependencies  

- The weekend is coming up, and I hope to get my hands on the keyboard. Only did a few things tonight:
  - Added `helmet` as a dependency & update `nodemailer`
...
## 📢 Developer's Notes - Password reset functionality

- Added two landing pages on the `/recover` & `/recover/:token` routes
- Added two GET & two POST requests on the routes above
- Added 4 controller methods for the functionality on these two routes

- The business owner wanted to change a few things:
  - Changes to AstroAuction Web Application (railway)
    - [ ] AstroAuction.com currently points to The Lost And Found webpage
    - [X] Add password reset functionality

  ---------------------------------------------------------------------------------------------------------------------------
# 🛠️ AstroAuction Patch 0.9.025
...
- The business owner wanted to change a few things:
  - Changes to AstroAuction Web Application (railway)
    - [ ] AstroAuction.com currently points to The Lost And Found webpage
    - [X] Change Astro Auction to AstroAuction.com
    - [X] Change hero text (streamline)
    - [X] Move login to left hand side
    - [X] Center the logo
    - [ ] Add password reset functionality
  - The Lost And Found Web Page (netlify)
    - [X] Change The Lost And Found to AstroAuction
    - [X] Remove Boxes 2,3,4
    - [X] Add Instagram to the Lost And Found
    - [X] Instagram should be more visible

  ---------------------------------------------------------------------------------------------------------------------------
# 🛠️ AstroAuction Patch 0.9.024
📅 **Release Date:** February 23th, 2026

## 📢 Developer's Notes

- Remove before/after slider on static site
- I apologize if this project was not the expectation
  - A variety of things that I wanted for this project:
    - Scrolling announcement banner - websockets
    - Optimize controller methods
    - Multi image support
    - Bidding functionality
    - Reset password
    - Admin control panel/moderation tools
    - Edit/Update listings
    - Listings marked as closed

  ---------------------------------------------------------------------------------------------------------------------------
# 🛠️ AstroAuction Patch 0.9.023
...
- The `/viewAuction/:id` landing page now renders dynamic data
  - Guest users & registered users may view detailed listings
